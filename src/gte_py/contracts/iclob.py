...
class ICLOB:
    ...
    def deposit(self, token_address: str, amount: int, sender_address: str, **kwargs) -> Dict[str, Any]:
        """
    ...
    def withdraw(self, token_address: str, amount: int, sender_address: str, **kwargs) -> Dict[str, Any]:
        """
    ...
    def post_limit_order(self, args: ICLOBPostLimitOrderArgs, sender_address: str, **kwargs) -> Dict[str, Any]:
        """
    ...
    def post_fill_order(self, args: ICLOBPostFillOrderArgs, sender_address: str, **kwargs) -> Dict[str, Any]:
        """
