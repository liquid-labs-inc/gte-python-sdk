...
class MarketService:
    ...
    def __init__(self, web3: AsyncWeb3, router_address: ChecksumAddress):
        ...
        self._clob_factory: CLOBFactory | None = None
    ...
    async def init(self):
        ...
        self._clob_factory_address: ChecksumAddress = await self.router.get_clob_factory()
        self._clob_factory = CLOBFactory(web3=self._web3, contract_address=self._clob_factory_address)
    ...
    async def get_market_info_by_address(self, address: ChecksumAddress) -> Market:
        ...
        return await self.get_market_info(iclob)
